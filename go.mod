module github.com/PRO-Robotech/sgroups

go 1.25.0

require (
	buf.build/go/protovalidate v0.14.0
	github.com/H-BF/corlib v1.2.30-dev
	github.com/Masterminds/squirrel v1.5.4
	github.com/PRO-Robotech/nft-go v0.0.4-dev.3
	github.com/PRO-Robotech/nftrace v0.0.8
...
replace (
	...
	go.opentelemetry.io/otel/metric => go.opentelemetry.io/otel/metric v1.17.0
	go.opentelemetry.io/otel/sdk => go.opentelemetry.io/otel/sdk v1.17.0
...
replace github.com/PRO-Robotech/sgroups-proto v0.2.0 => github.com/MaksimSkorobogatov/sgroups-proto v0.4.4 // TODO: delete before merging
