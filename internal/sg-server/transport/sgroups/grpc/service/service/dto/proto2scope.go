...
func init() {
	dto.Register[*pb.ServiceReq_Watch, filter.Scope](watchReqToScope)
}
...
type proto2scopeVariants interface {
	*dto.Pair[*pb.ServiceReq_Watch, filter.Scope]
	Convert() error
}

func watchReqToScope(src *pb.ServiceReq_Watch) (dest filter.Scope, err error) {
