...
func NewSgHostService(ctx context.Context, r repository.Repository, c agent.ClientProvider, opts ...service.Option) server.APIService {
	ret := &hostService{
		appCtx:         ctx,
		rep:            r,
		clientProvider: c,
...
type hostService struct {
	...
	clientProvider agent.ClientProvider
}
