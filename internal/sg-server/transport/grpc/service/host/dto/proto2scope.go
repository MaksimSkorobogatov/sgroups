...
func init() {
	dto.Register[*pb.HostReq_Watch, filter.Scope](watchReqToScope)
}
...
type proto2scopeVariants interface {
	*dto.Pair[*pb.HostReq_Watch, filter.Scope]
	Convert() error
}

func watchReqToScope(src *pb.HostReq_Watch) (dest filter.Scope, err error) {
