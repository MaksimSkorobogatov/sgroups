...
func init() {
	dto.Register[*pb.NamespaceReq_Watch, filter.Scope](watchReqToScope)
}
...
type proto2scopeVariants interface {
	*dto.Pair[*pb.NamespaceReq_Watch, filter.Scope]
	Convert() error
}

func watchReqToScope(src *pb.NamespaceReq_Watch) (dest filter.Scope, err error) {
